...
namespace PeerStack.Encoding
{
    ...
    /// <remarks>
    ///   <para>
    ///   A codec for a hexadecimal string, <see cref="Encode"/> and <see cref="Decode"/>.  
    ///   Adds the extension method <see cref="ToHexString"/> to encode a byte array 
    ///   and <see cref="ToHexBytes"/> to decode a hexadecimal <see cref="string"/>.
    ///   </para>
    /// </remarks>
