...
namespace PeerTalk.Core.Ipns
{
    ...
    ///   is the node's own <see cref="Peer.Id"/>, which is the hash of its public key.
    /// </remarks>
    /// <seealso href="https://specs.ipfs.tech/ipns/ipns-record/#dfn-InterPlanetary%20Naming%20System%20(IPNS)">Name API spec</seealso>
    public interface INameService
    {
        ...
        /// </returns>
        Task<NamedContent> PublishAsync(string path, bool resolve = true, string key = "self", TimeSpan? lifetime = null, CancellationToken cancel = default);
        ...
        ///   the <see cref="NamedContent"/> of the published content.
        /// </returns>
        Task<NamedContent> PublishAsync(Cid id, string key = "self", TimeSpan? lifetime = null, CancellationToken cancel = default);
        ...
        /// </returns>
        Task<string> ResolveAsync(string name, bool recursive = false, bool nocache = false, CancellationToken cancel = default);
    }
}
