...
namespace PeerTalk.Dns
{
    ...
    /// </summary>
    /// <remarks>
    ///   The _memberTextReader representation of a <see cref="ResourceRecord"/>.
    ...
    {
        /// <summary>
        ///   Reads the _memberTextReader representation of a resource record.
        /// </summary>
        /// <param name="reader">
        ...
        /// <summary>
        ///  Writes the _memberTextReader representation of a resource record.
        /// </summary>
        /// <param name="writer">
