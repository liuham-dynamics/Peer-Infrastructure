...
namespace PeerTalk.Dns.Records
{
    ...
    public class ResourceRecord : ADnsRecord, IPresentationSerialiser
    {
        ...
        {
            // TODO: Check usage.  Should not be used because its a string.
            get
            {
        ...
        public int GetDataLength()
        {
            ...
            {
                var writer = new DnsWireWriter(ms);
        ...
        /// <inheritdoc />
        public override IWireSerialiser Read(DnsWireReader reader)
        {
        ...
        /// </remarks>
        public virtual void ReadData(DnsWireReader reader, int length)
        {
        }

        /// <inheritdoc />
        public override void Write(DnsWireWriter writer)
        {
        ...
        ///   Derived classes must implement this method.
        /// </remarks>
        public virtual void WriteData(DnsWireWriter writer)
        {
        }
