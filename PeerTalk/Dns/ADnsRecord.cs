...
namespace PeerTalk.Dns
{
    ...
    ///   cloning and caching.
    /// </remarks>
    public abstract class ADnsRecord : IWireSerialiser, ICloneable
    {
        /// <summary>
        ...
        public int Length()
        {
            var writer = new DnsWireWriter(Stream.Null);
            Write(writer);
        ...
        /// </summary>
        /// <typeparam name="T">
        ///   Some type derived from <see cref="ADnsRecord"/>.
        /// </typeparam>
        /// <returns>
        ///   A deep copy of the dns object.
        /// </returns>
        ...
        /// </remarks>
        public T Clone<T>() where T : ADnsRecord
        {
            return (T)Clone();
        }
        ...
        public IWireSerialiser Read(byte[] buffer, int offset, int count)
        {
            ...
            {
                return Read(new DnsWireReader(ms));
            }
        }
        ...
        {
            return Read(new DnsWireReader(stream));
        }

        /// <inheritdoc />
        public abstract IWireSerialiser Read(DnsWireReader reader);
        ...
        {
            Write(new DnsWireWriter(stream));
        }

        /// <inheritdoc />
        public abstract void Write(DnsWireWriter writer);
    }
}
